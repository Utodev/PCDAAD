...
begin
 ...
 asm
    ...
    final DS apunta a a vete a saber donde porque no estсn los tres en el mismo segmento}
    MOV AH, B   {ademсs, podriamos prescindir del DDBRAM porque si quiren lo pueden cargar desde el extern}
